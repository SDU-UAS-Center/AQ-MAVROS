...
#include "aq_mavros/drone_pos.h"
#include "aq_mavros/drone_pose.h"
#include "aq_mavros/drone_waypoint.h"
#include "aq_mavros/IntStamped.h"
#include "aq_mavros/UInt32Stamped.h"
#include "mavlink.h"
#include "autoquad.h"
#include <sstream>
...
//					pub_to_mavlink.publish(msg_out);
		...
		case MAVLINK_MSG_ID_MISSION_ITEM_REACHED:
		{
			...
			aq_mavros::UInt32Stamped msg_out;
...
*/
void on_drone_waypoint(const aq_mavros::drone_waypoint::ConstPtr& msg){
...
void on_drone_set_current_waypoint(const aq_mavros::IntStamped::ConstPtr& msg){
...
int main(int argc, char **argv){
  ...
  pub_drone_fused_position = n.advertise<aq_mavros::drone_pose>(drone_fused_position_pub, 1000);
  pub_drone_gps_position = n.advertise<aq_mavros::drone_pos>(drone_gps_position_pub, 1000);
  pub_drone_wp_reached = n.advertise<aq_mavros::UInt32Stamped>(drone_wp_reached_pub, 1000);
