						       ...
						       uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, float param1, float param2, float param3, float param4, float param5, float param6, float param7)
{
	...
	std::cout << "parm 1: " << (int)param1 << "\n";
	std::cout << "parm 2: " << (int)param2 << "\n";
	std::cout << "parm 3: " << (int)param3 << "\n";
	std::cout << "parm 4: " << (int)param4 << "\n";
	std::cout << "parm 5: " << (int)param5 << "\n";
	std::cout << "parm 6: " << (int)param6 << "\n";
	std::cout << "parm 7: " << (int)param7 << "\n";
	std::cout << "command: " << (int)command << "\n";
	std::cout << "target_system " << (int)target_system << "\n";
	std::cout << "target_component: " << (int)target_component << "\n";
	std::cout << "confirmation: " << (int)confirmation << "\n";

	for(int i = 0; i < 33; i++){
		std::cout << i << ": " <<  msg->payload64[i] << "\n";
	}
